...
import com.example.retail.models.vegitables.VegitablesPage;
...
public class VegitablesRetailerController {
    ...
    public ResponseEntity<Object> findAllVegitablesWithPagination(VegitablesPage vegitablesPage) {
        Page<Vegitables> result = vegitablesService.findPaginatedVegitables(vegitablesPage);
