...
public class EdibleProducts {
    ...
    private Date edibleProducts_Expiry;
    ...
    private Float edibleProducts_CostPrice;
    ...
    // This product added by user
    private String edibleProducts_AddedBy;

    // Date time added and increament in inventory count
    private HashMap edibleProducts_AdditionDetail;

    public EdibleProducts(){}

    public EdibleProducts(Long edibleProducts_TableId, @NotNull String edibleProducts_Id, String edibleProducts_productName, String edibleProducts_Name, String edibleProducts_AlternaleName, String edibleProducts_Category, String edibleProducts_Manufacturer, String edibleProducts_Variant, String edibleProducts_Type, String edibleProducts_Flavor, String edibleProducts_Desc, Date edibleProducts_Expiry, Boolean edibleProducts_ForMinors, String edibleProducts_MeasureMentUnit, Float edibleProducts_Denomination, Integer edibleProducts_InventoryCount, Float edibleProducts_CostPrice, Float edibleProducts_Mrp, Float edibleProducts_MaxDiscount, Float edibleProducts_ShowDiscount, Float edibleProducts_OfferedDiscount, Float edibleProducts_Tax, String edibleProducts_AddedBy, HashMap edibleProducts_AdditionDetail) {
        ...
        this.edibleProducts_Expiry = edibleProducts_Expiry;
        ...
        this.edibleProducts_CostPrice = edibleProducts_CostPrice;
        ...
        this.edibleProducts_AddedBy = edibleProducts_AddedBy;
        this.edibleProducts_AdditionDetail = edibleProducts_AdditionDetail;
    }
    ...
    public Date getEdibleProducts_Expiry() {
        return edibleProducts_Expiry;
    }

    public void setEdibleProducts_Expiry(Date edibleProducts_Expiry) {
        this.edibleProducts_Expiry = edibleProducts_Expiry;
    }
    ...
    public Float getEdibleProducts_CostPrice() {
        return edibleProducts_CostPrice;
    }

    public void setEdibleProducts_CostPrice(Float edibleProducts_CostPrice) {
        this.edibleProducts_CostPrice = edibleProducts_CostPrice;
    }
    ...
    public String getEdibleProducts_AddedBy() {
        return edibleProducts_AddedBy;
    }

    public void setEdibleProducts_AddedBy(String edibleProducts_AddedBy) {
        this.edibleProducts_AddedBy = edibleProducts_AddedBy;
    }

    public HashMap getEdibleProducts_AdditionDetail() {
        return edibleProducts_AdditionDetail;
    }

    public void setEdibleProducts_AdditionDetail(HashMap edibleProducts_AdditionDetail) {
        this.edibleProducts_AdditionDetail = edibleProducts_AdditionDetail;
    }
}
